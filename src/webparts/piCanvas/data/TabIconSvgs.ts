/**
 * TabIconSvgs — Lucide-style inline SVG icons for cross-platform tab rendering.
 *
 * Each SVG uses width="1em" height="1em" so it scales with the tab font size,
 * and stroke="currentColor" so it inherits the tab text color.
 *
 * Keys match the icon preset keys from getIconPresets() in PiCanvasWebPart.ts.
 */

const s = (d: string): string =>
  `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${d}</svg>`;

export const TAB_ICON_SVGS: Record<string, string> = {
  // Navigation & General
  ...
  Contact: s('<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>'),
  ...
  News: s('<path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/>'),
  ...
  Add: s('<line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/>'),
  Delete: s('<polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/>'),
